...
if sys.argv:
    ...
    xdmf_path = "vel.00000080.xdmf2"
    png_path = "vel.00000080.png"
import paraview
...
disp = GetDisplayProperties(xdmf)
tmpLUT = GetColorTransferFunction('vort')
tmpLUT.RGBPoints = [
    ...
    0.38039200000000006, 0.992541, 0.736947, 0.420146, 0.5058820000000002,
...
ColorBy(disp, ('CELLS', 'vort', 'X'))

view.CameraParallelProjection = 1
view.UseColorPaletteForBackground = 0
view.Background = 1, 1, 1

bnd = xdmf.GetDataInformation().GetBounds()
margin = 0
cx = 0.5 * (bnd[0] + bnd[1])
cy = 0.5 * (bnd[2] + bnd[3])
cz = 0.5 * (bnd[4] + bnd[5])
