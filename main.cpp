  ...
  void operator()(VectorLab &lab, BlockInfo &info) {
    ...
    for (int iy = 0; iy < _BS_; ++iy)
      for (int ix = 0; ix < _BS_; ++ix) {
        ...
        Real u = lab(ip0, jp0).u[0];
        Real v = lab(ip0, jp0).u[1];
        Real up1x0 = lab(ip1, jp0).u[0];
        Real up2x0 = lab(ip2, jp0).u[0];
        Real up3x0 = lab(ip3, jp0).u[0];
        Real um1x0 = lab(im1, jp0).u[0];
        Real um2x0 = lab(im2, jp0).u[0];
        Real um3x0 = lab(im3, jp0).u[0];
        Real up1y0 = lab(ip0, jp1).u[0];
        Real up2y0 = lab(ip0, jp2).u[0];
        Real up3y0 = lab(ip0, jp3).u[0];
        Real um1y0 = lab(ip0, jm1).u[0];
        Real um2y0 = lab(ip0, jm2).u[0];
        Real um3y0 = lab(ip0, jm3).u[0];
        Real up1x1 = lab(ip1, jp0).u[1];
        Real up2x1 = lab(ip2, jp0).u[1];
        Real up3x1 = lab(ip3, jp0).u[1];
        Real um1x1 = lab(im1, jp0).u[1];
        Real um2x1 = lab(im2, jp0).u[1];
        Real um3x1 = lab(im3, jp0).u[1];
        Real up1y1 = lab(ip0, jp1).u[1];
        Real up2y1 = lab(ip0, jp2).u[1];
        Real up3y1 = lab(ip0, jp3).u[1];
        Real um1y1 = lab(ip0, jm1).u[1];
        Real um2y1 = lab(ip0, jm2).u[1];
        Real um3y1 = lab(ip0, jm3).u[1];
