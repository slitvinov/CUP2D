...
FishData::FishData(Real L, Real _h)
    : length(L), h(_h), rS(new Real[Nm]), rX(new Real[Nm]), rY(new Real[Nm]),
      vX(new Real[Nm]), vY(new Real[Nm]), norX(new Real[Nm]),
      norY(new Real[Nm]), vNorX(new Real[Nm]), vNorY(new Real[Nm]),
      width(new Real[Nm]) {
  if (dSref <= 0) {
