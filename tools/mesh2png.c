...
static int arg_i(int argc, char **argv, const char *key) {
  ...
  if (end == s || *end) { fprintf(stderr, "mesh2png: -%s: bad '%s'\n", key, s); exit(1); }
  return (int)v;
}
