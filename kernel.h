struct KernelComputeForces {
  ...
  void operator()(VectorLab &l, ScalarLab &chi, const BlockInfo &info,
	...
	int x0 = x;
	int y0 = y;
        const Vector *l00 = &l(x0, y0);
        const Vector *l01 = &l(x0 + sx, y0);
        const Vector *l02 = &l(x0 + 2 * sx, y0);
        const Vector *l03 = &l(x0 + 3 * sx, y0);
        const Vector *l04 = &l(x0 + 4 * sx, y0);
        const Vector *l05 = &l(x0 + 5 * sx, y0);
        const Vector *l06 = &l(x0, y0 + sy);
        const Vector *l07 = &l(x0, y0 + 2 * sy);
        const Vector *l08 = &l(x0, y0 + 3 * sy);
        const Vector *l09 = &l(x0, y0 + 4 * sy);
        const Vector *l10 = &l(x0, y0 + 5 * sy);
        const Vector *l11 = &l(x0 - 1, y0);
        const Vector *l12 = &l(x0 + 1, y0);
        const Vector *l13 = &l(x0, y0 - 1);
        const Vector *l14 = &l(x0, y0 + 1);
        const Vector *l15 = &l(x0 + 2 * sx, y0 + sy);
        const Vector *l16 = &l(x0 + 2 * sx, y0 + 2 * sy);
        const Vector *l17 = &l(x0 + sx, y0 + sy);
        const Vector *l18 = &l(x0 + sx, y0 + 2 * sy);

	int ix0 = ix;
	int iy0 = iy;
        const Vector *l19 = &l(ix0, iy0);
